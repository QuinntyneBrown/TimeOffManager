...
{
    public class UpdateDevelopmentTeam
    {
        ...
        public class Handler: IRequestHandler<Request, Response>
        {
            ...
            {
                var developmentTeam = await _context.DevelopmentTeams.SingleAsync(x => x.DevelopmentTeamId == request.DevelopmentTeam.DevelopmentTeamId);
